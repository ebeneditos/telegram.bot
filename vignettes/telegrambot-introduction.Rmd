...
If you want to learn how to build a bot that is continuously running and is able to respond to multiple input data formats, you can check the next section, [Building an R Bot in 3 steps](https://github.com/ebeneditos/telegram.bot/wiki/Tutorial-–-Building-an-R-Bot-in-3-steps).

### Attribution

This vignette was inspired by [this tutorial](https://www.codementor.io/garethdwyer/building-a-telegram-bot-using-python-part-1-goi5fncay).

...
Want more? In the next page [Basic Functionalities](https://github.com/ebeneditos/telegram.bot/wiki/basic-functionalities) you can learn how to add some useful functionalities to the Bot.

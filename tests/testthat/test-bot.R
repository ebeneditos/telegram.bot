...
test_that("Send Audio", {
  ...
  expect_is(bot$sendAudio(chat_id = chat_id,
...
test_that("Send Sticker", {
  ...
  expect_is(bot$sendSticker(chat_id = chat_id,
...
test_that("Send Video", {
  ...
  expect_is(bot$sendVideo(chat_id = chat_id,
...
test_that("Send Video Note", {
  ...
  expect_is(bot$sendVideoNote(chat_id = chat_id,
...
test_that("Send Voice", {
  ...
  expect_is(bot$sendVoice(chat_id = chat_id,
